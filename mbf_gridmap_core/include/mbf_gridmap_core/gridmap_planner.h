...
public:
   ...
   * @param local_gridmap_ptr A shared pointer to the local costmap (gridmap) to use for planning
   * @param global_gridmap_ptr A shared pointer to the global costmap (gridmap) to use for planning
